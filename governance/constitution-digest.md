...
**Bound to governance/constitution.md sha256 `90bb5841d3eeb89d3db50908f8ec53e21869b79a7c726d16cdaf613468a43236`.** If this digest drifts from that file, the
...
1. **The gate decides** — verify/ (run.js + mutation.js + gate.js). No model opinion merges. *(deploy-blocking since 2026-08-28 — R-GATE closed, DR-013.)*
...
8. **Scope** — Production; catalogue v2.0; Track C **audited** (security_scope_audited=true); production_eligible=false (computed) while open blockers remain (Track-C C-02/C-03/C-05/C-06/C-09/C-26 + Part-1 R-SEP/R-VENDOR/R-OBSV; R-GATE closed 2026-08-28, DR-013).
