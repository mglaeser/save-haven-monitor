...
const CRISES = [
  {
    id: "ai2026", name: "AI Investment Bubble", years: "2026 · POTENTIAL", cat: "A", weight: 1.0, potential: true,
    ...
    series: [
      { key: "mkt", label: "NASDAQ-100 (feared market)", cls: "market", color: "#E05252", end: 0,
        a: [[-60,100],[-56,111],[-50,88],[-43,70],[-37,101],[-28,121],[-24,139],[-18,144],[-17,138],[-15,111],[-10,150],[-7,161],[-3,154],[-1,205],[0,196]] },
      { key: "au", label: "Gold — lead regime-matched hedge", cls: "category", color: "#E0B458", dashed: true, end: 0, w: 2.5,
        a: [[-60,100],[-45,92],[-37,107],[-28,122],[-19,146],[-16,167],[-10,210],[-7,252],[-5,311],[-2,240],[0,230]] },
      { key: "cash", label: "3M T-bills / cash (TR) — phase 1", cls: "universal", color: "#BBCF6A", dashed: true, end: 0,
        a: [[-60,100],[-48,100.4],[-43,101.5],[-36,104],[-31,107],[-19,112],[-7,117],[0,119.5]] },
      { key: "ust", label: "10Y US Treasuries (TR) — challenged", cls: "universal", color: "#5B8DEF", dashed: true, end: 0,
        a: [[-60,100],[-50,96],[-43,85],[-33,82],[-31,86],[-19,88],[-7,93],[0,95]] },
      { key: "chf", label: "Swiss franc (vs USD)", cls: "category", color: "#7EC8E3", dashed: true, end: 0,
        a: [[-60,100],[-45,92],[-31,109],[-19,101],[-8,113],[-5,120],[0,113]] },
      { key: "usd", label: "US dollar (DXY)", cls: "category", color: "#8FAE5D", dashed: true, end: 0,
        a: [[-60,100],[-46,125],[-31,110],[-19,117],[-12,104],[-6,106],[0,110]] },
      { key: "jpy", label: "Japanese yen (failed this cycle)", cls: "falsified", color: "#5AA9A3", dashed: true, end: 0,
        a: [[-60,100],[-45,73],[-33,74],[-24,68],[-12,72],[0,68]] },
      { key: "btc", label: "Bitcoin (risk asset)", cls: "falsified", color: "#E8853D", dashed: true, end: 0,
        a: [[-60,100],[-56,203],[-43,47],[-37,79],[-19,274],[-9,371],[-7,312],[-3,220],[0,182]] },
    ],
  },
  {
    id: "depression", name: "Great Depression", years: "1929–34", cat: "A", weight: 1.0,
    peak: "Sep 1929",
    ...
    series: [
      { key: "mkt", label: "Dow Jones Industrial", cls: "market", color: "#E05252",
        a: [[-60,100],[-48,112],[-36,130],[-24,160],[-12,220],[-6,255],[0,300],[1,285],[2,156],[7,231],[12,190],[20,130],[26,90],[34,32],[40,52],[46,70],[54,78],[60,73]] },
      { key: "hm", label: "Homestake Mining (gold shares)", cls: "unique", color: "#E0B458",
        a: [[-60,100],[-24,102],[0,105],[6,118],[12,140],[24,220],[34,360],[40,600],[48,625],[60,660]] },
      { key: "gb", label: "Long-term US govt bonds", cls: "universal", color: "#5B8DEF",
        a: [[-60,100],[0,104],[12,110],[20,116],[26,109],[34,122],[48,130],[60,135]] },
      { key: "cash", label: "Cash (real purchasing power) — phase 1", cls: "universal", color: "#BBCF6A",
        a: [[-60,100],[0,100],[12,107],[24,118],[34,131],[40,135],[60,129]] },
    ],
  },
  {
    id: "stagflation", name: "Stagflation / Nifty Fifty", years: "1973–74", cat: "A", weight: 1.0,
    peak: "Jan 1973",
  ...
  },
  {
    ...
    series: [
      { key: "mkt", label: "Nikkei 225", cls: "market", color: "#E05252",
      ...
      { key: "jgb", label: "JGBs 10Y (total return)", cls: "universal", color: "#5B8DEF",
        a: [[-60,100],[-24,112],[0,118],[6,112],[9,110],[12,116],[24,128],[36,140],[48,152],[60,165]] },
      { key: "jpy", label: "Japanese yen (vs USD)", cls: "category", color: "#5AA9A3",
        a: [[-60,100],[-36,152],[-24,158],[-12,175],[0,174],[12,180],[24,190],[30,198],[48,225],[60,252]] },
      { key: "cash", label: "Yen cash / call rate (TR) — phase 1", cls: "universal", color: "#BBCF6A",
        a: [[-60,100],[-24,112],[0,124],[12,133],[18,137],[30,142],[48,148],[60,151]] },
      { key: "puts", label: "Rolling Nikkei puts (stylized)", cls: "unique", color: "#B48CE0",
        a: [[-60,100],[-36,84],[-12,68],[0,60],[6,120],[9,205],[12,235],[24,290],[30,420],[42,395],[60,350]] },
    ],
  },
  {
    id: "blackmonday", name: "Black Monday", years: "1987", cat: "E", weight: 0.7,
    peak: "Aug 1987",
    ...
    series: [
      ...
      { key: "ust", label: "Long US Treasuries (TR)", cls: "universal", color: "#5B8DEF",
      ...
      { key: "cash", label: "3M T-bills / cash (TR) — phase 1", cls: "universal", color: "#BBCF6A",
        a: [[-60,100],[-24,124],[-12,134],[0,145],[6,149],[12,155],[24,168],[48,196],[60,208]] },
      { key: "puts", label: "Index puts / long volatility (stylized)", cls: "universal", color: "#9A7BD6",
        a: [[-60,100],[-24,80],[-12,70],[0,64],[1,66],[2,175],[4,160],[12,120],[24,100],[60,80]] },
    ],
  },
  {
    id: "asia", name: "Asian Financial Crisis", years: "1997–98", cat: "D", weight: 0.8,
    peak: "Jun 1997",
    ...
    series: [
      { key: "mkt", label: "Thai equities (USD terms)", cls: "market", color: "#E05252",
        a: [[-60,100],[-42,195],[-30,175],[-24,160],[-12,138],[-3,120],[0,110],[3,72],[6,38],[10,28],[14,22],[24,40],[30,46],[48,44],[60,50]] },
      { key: "usd", label: "US dollar (vs THB)", cls: "category", color: "#8FAE5D",
        a: [[-60,100],[-12,100],[0,101],[1,113],[3,135],[5,165],[7,215],[10,180],[14,163],[24,150],[36,155],[48,168],[60,172]] },
      { key: "aul", label: "Gold in local currency (THB)", cls: "category", color: "#E0B458",
        a: [[-60,100],[-12,92],[0,88],[3,108],[7,150],[14,132],[30,118],[60,112]] },
      { key: "ust", label: "US Treasuries (TR)", cls: "universal", color: "#5B8DEF",
        a: [[-60,100],[-12,124],[0,130],[7,138],[14,148],[24,150],[48,165],[60,175]] },
    ],
  },
  {
    id: "dotcom", name: "Dot-com Bust", years: "2000–02", cat: "A", weight: 1.0,
    peak: "Mar 2000",
    ...
    series: [
      { key: "mkt", label: "NASDAQ Composite", cls: "market", color: "#E05252",
  ...
  },
  {
    ...
    series: [
      ...
      { key: "cta", label: "Trend-following / CTA", cls: "universal", color: "#4F79C9",
      ...
      { key: "vol", label: "Long volatility (stylized)", cls: "universal", color: "#9A7BD6",
        a: [[-60,100],[-36,86],[-12,76],[0,72],[5,88],[11,118],[13,190],[14,210],[17,196],[24,152],[36,132],[48,124],[60,118]] },
    ],
  },
  {
    id: "euro", name: "European Sovereign Debt Crisis", years: "2010–12", cat: "D", weight: 0.8,
  ...
  },
  {
    ...
    series: [
      ...
      { key: "usd", label: "US dollar (DXY)", cls: "category", color: "#8FAE5D",
        a: [[-60,100],[-24,95],[0,104],[1,107],[4,100],[10,94],[24,101],[32,119],[48,110],[60,112]] },
      { key: "btc", label: "Bitcoin (falsified safe haven)", cls: "falsified", color: "#E8853D", dashed: true, defaultOff: true,
        a: [[-60,100],[-27,8190],[-14,1542],[-8,4500],[0,4000],[1,2083],[3,3900],[8,4800],[14,26250],[22,19583],[34,6875],[49,29167],[60,40417]] },
    ],
  },
  {
    id: "southsea", name: "South Sea Bubble", years: "1720", cat: "C", weight: 1.0,
    peak: "Jun 1720", stylizedAll: true,
    ...
    series: [
      { key: "mkt", label: "South Sea Co. shares", cls: "market", color: "#E05252",
        a: [[-60,100],[-24,100],[-12,102],[-6,116],[-5,140],[-4,210],[-3,330],[-2,560],[-1,780],[0,950],[1,870],[2,620],[3,320],[4,210],[6,155],[12,130],[24,125],[60,128]] },
      { key: "hoare", label: "Hoare's Bank timed exit (stylized)", cls: "unique", color: "#B48CE0",
        a: [[-60,100],[-12,104],[-6,108],[-4,120],[-2,142],[0,158],[1,166],[3,168],[12,170],[60,178]] },
      { key: "boe", label: "Bank of England stock", cls: "category", color: "#5AA9A3",
        a: [[-60,100],[-12,102],[0,108],[2,92],[4,88],[8,96],[12,102],[24,108],[60,118]] },
      { key: "cash", label: "Cash / specie & land", cls: "category", color: "#8FAE5D",
...
const MATRIX = [
  { name: "Gold", vals: [2, 2, 1, 1, 1, 1, 0, 2, 2, 1, 3],
  ...
  { name: "Long safe govt bonds", vals: [2, 0, 2, 2, 2, 2, 2, 2, 2, 2, 3],
  ...
  { name: "Cash / T-bills / USD liquidity", vals: [2, 1, 2, 2, 2, 2, 2, 2, 1, 2, 3],
  ...
  { name: "Japanese yen", vals: [-1, -1, 2, 2, 1, 2, 1, 2, 1, 1, 3],
  ...
  { name: "Swiss franc", vals: [-1, -1, -1, 2, 1, 2, 1, 2, 2, 1, 3],
  ...
  { name: "US dollar", vals: [-1, 0, -1, 1, 2, 2, 1, 2, 1, 2, 3],
  ...
  { name: "Value / small-value stocks", vals: [-1, 1, -1, -1, -1, -1, 2, 0, -1, 0, 3],
  ...
  { name: "Low-beta / quality (QMJ)", vals: [-1, -1, -1, 2, -1, -1, 2, 2, 2, 2, 3],
    notes: { 7: "QMJ shows mild positive convexity — benefits from flight to quality (Asness, Frazzini & Pedersen 2019)." } },
  { name: "Trend-following / CTA", vals: [-1, 2, 2, 1, 2, 1, 2, 2, 1, 1, 3],
  ...
  { name: "Long volatility / index puts", vals: [-1, -1, -1, 2, -1, 2, 2, 2, 2, 2, 3],
  ...
  { name: "Bitcoin", vals: [-1, -1, -1, -1, -1, -1, -1, -1, -1, 0, 3],
...
const CLASSIFICATION = [
  { title: "Universal winners — two phases", tag: "U", color: "#5B8DEF",
  ...
  { title: "Category-specific winners", tag: "C", color: "#E0B458",
  ...
  { title: "Crisis-unique winners", tag: "★", color: "#B48CE0",
  ...
  { title: "Falsified candidates", tag: "!", color: "#E8853D",
...
function runFan(specs, seed, sims = 1500, block = 6, H = 60) {
  ...
  const q = (arr, f) => { const a = [...arr].sort((x, y) => x - y); return a[Math.min(a.length - 1, Math.floor(f * a.length))]; };
