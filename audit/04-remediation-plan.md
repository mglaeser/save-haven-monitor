...
- **Wave 1 (STOP-SHIP + BLOCKER-1 core):** commission the gate (verify/ + CI) in observe-only →
  ...
  *(R-GATE closed 2026-08-28, DR-013: the ruleset requires the checks; enforcement is live.)*
...
| Deploy admission without ratified constitution/evidence | **Partial** | engagement-status computed + gate fail-closed; deploy-*blocking* live since 2026-08-28 (R-GATE closed, DR-013) |
