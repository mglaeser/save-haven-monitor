...
| B-11 | BLOCKER-1 | PARTIAL | Add an external scheduled health check (e.g., an Action hitting <prod-host> asserting the app boots + a cont |
...
| B-28 | BLOCKER-2 | FAIL | Add a scheduled synthetic monitor (GitHub Actions cron, out-of-band) that GETs https://<prod-host>, asserts  |
...
| A-35 | SHOULD-FIX | FAIL | Do not add a human to any queue. Build automatic containment: a synthetic monitor on <prod-host> that auto-r |
