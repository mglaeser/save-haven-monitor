(() => {
    ...
    MATRIX: [
      {
        ...
        notes: {
          "0": "Rose via gold-mining shares (Homestake +474–580%) under the fixed gold price.",
          "3": "Spiked intraday on Black Monday (+4.2%) then sold off as investors liquidated for cash — an 'ATM' in acute liquidity crunches; weak-to-strong per Baur & McDermott (2010).",
          "4": "Rose in local-currency terms as EM currencies collapsed.",
          "6": "Fell ≈ −27% into the peak and stayed weak — the key exception that demotes gold from universal status.",
          "7": "Strong safe haven at the crisis peak (Baur & McDermott 2010).",
          "10": "ELEVATED to lead regime-matched hedge: 2026 hedge score 0.85 (co-lead with cash at 0.88) — regime-match r 0.96–0.98 vs monetary-crisis scripts, worst-quintile beta ≈ 0, Granger-leads the market; 27% of global reserves, overtaking US Treasuries at 22% (ECB, 2 Jun 2026); record central-bank demand (WGC, Jun 2026). Caveat: ~$4,100 after the $5,595 Jan-2026 record — part of the hedge is pre-paid."
        }
      },
      {
        ...
        notes: {
          "1": "Collapsed in real terms — bonds fail in inflationary regimes.",
          "8": "Core Bunds/Treasuries only; periphery sovereigns were the collapsing asset.",
          "9": "Rallied in the crash, then fell ≈ −25% in the 2022 inflation regime.",
          "10": "Challenged: in April 2025 Treasuries, USD and equities fell TOGETHER; BIS (Sep 2025) found Treasury safe-haven correlations near zero since. 2026 hedge score 0.42 — demoted to 5th, behind CHF, for this configuration (Cheema, Ryan & Sarwar 2025: bonds work best in macro/financial downturns, weaker in geopolitical/inflation shocks)."
        }
      },
      {
        ...
        notes: {
          "0": "Deflation lifted the real value of cash ~25% peak-to-trough.",
          "1": "Positive nominal T-bill yields but negative real returns in the inflationary regime.",
          "9": "March 2020 'dash for cash': even Treasuries sold off while T-bills and money-market funds absorbed record inflows (Duffie 2020; BIS Bulletin No. 2).",
          "10": "The live phase-1 haven: money-market fund assets at a record $7.95tn (ICI, 1 Jul 2026). 2026 hedge score 0.88 — rank #1 on CERTAINTY (100% worst-month hit rate, no drawdown, par entry); gold is the payoff co-lead."
        }
      },
      {
        name: "Japanese yen",
        ...
        notes: {
          "7": "Appreciated ≈ +23% vs USD through the acute phase (Ranaldo & Söderlind 2010).",
          "10": "~¥162 — a ~40-year low; carry dominates haven flows, so the yen has NOT behaved as a haven this cycle."
        }
      },
      {
        name: "Swiss franc",
        ...
        notes: {
          "8": "+~50% vs EUR until the SNB imposed the 1.20 floor in Sep 2011.",
          "10": "Credible secondary haven — the franc strengthened materially vs USD 2021–26 (USD/CHF ~0.76 in Jan 2026)."
        }
      },
      {
        name: "US dollar",
        ...
        notes: {
          "4": "The classic EM-crisis winner: +~115% vs THB at the extreme.",
          "9": "Spiked in the Mar 2020 dash-for-cash funding stress.",
          "10": "Worst first half since 1973 in H1 2025 (DXY −10.8%); reserve diversification away from USD documented (ECB, WGC)."
        }
      },
      {
        ...
        notes: {
          "1": "Equity-like returns, negatively correlated with stocks, positively with inflation (Gorton & Rouwenhorst 2006)."
        }
      },
      {
        name: "Oil / energy",
        ...
        notes: {
          "1": "Crude roughly quadrupled after the Oct 1973 embargo ($2.90 → $11.65/bbl by Jan 1974) — the highest-magnitude crisis-unique winner (Alpanda & Peralta-Alva 2010, Rev. Econ. Dynamics; Fed History).",
          "7": "Fell from ~$147 to ~$34 in the demand-driven collapse (Hamilton 2009, BPEA) — high uniqueness, low recurrence."
        }
      },
      {
        ...
        notes: {
          "6": "Small-value ≈ +16.2%/yr 2000–07 vs S&P +1.7%/yr — the post-bubble rotation.",
          "7": "Fell with the market during the crash itself; the premium is post-trough.",
          "10": "The dot-com analogue: value / equal-weight rotation is the leading candidate post-bubble winner if an AI unwind mirrors 2000–02."
        }
      },
      {
        ...
        notes: {
          "7": "QMJ shows mild positive convexity — benefits from flight to quality (Asness, Frazzini & Pedersen 2019)."
        }
      },
      {
        ...
        notes: {
          "3": "Crisis alpha is strongest in prolonged drawdowns, weaker in one-day crashes (Kaminski).",
          "7": "+14–18% in 2008 while equities halved (time-series momentum, Moskowitz et al. 2012)."
        }
      },
      {
        ...
        notes: {
          "3": "Via index puts / portfolio hedges — VIX futures only tradable since 2004, VIX options since 2006.",
          "7": "Long VIX futures/calls materially cut portfolio risk in 2008 (Szado 2009); VIX a stronger US hedge than gold (Hood & Malik 2013). Cost: persistently negative carry (Carr & Wu 2009).",
          "10": "Convex insurance is available and relatively cheap pre-spike; expected carry is negative between crises (Dew-Becker et al. 2017)."
        }
      },
      {
        name: "Bitcoin",
        ...
        notes: {
          "9": "Fell in lockstep with the S&P 500; a 10% allocation raised 1% portfolio VaR by 13.6% (Conlon & McGee 2020) — falsified as a safe haven.",
          "10": "−51% from the Oct 2025 ATH (~$126k) to ~$62k by Jul 2026 while equity indices set records — again trading as a risk asset."
        }
      }
    ],
    MX_CRISES: [
    ...
    CLASSIFICATION: [
      {
        ...
        color: "#5B8DEF",
        items: [
          "PHASE 1 · Cash / T-bills / USD liquidity — the first-response winner: flight to liquidity and record money-market inflows (Longstaff 2004; Nagel 2016; Krishnamurthy & Vissing-Jorgensen 2012; Baele et al. 2020; Duffie 2020 'dash for cash')",
          "PHASE 2 · Long safe sovereign bonds — 9/10 crises once funding stress eases; best in macro/financial downturns, weaker in geopolitical/inflation shocks (Cheema, Ryan & Sarwar 2025) and challenged since April 2025",
          "Long volatility / index puts — paid in every observed crisis; negative expected carry between crises (Szado 2009; Carr & Wu 2009)",
          "Trend-following / CTA — 'crisis alpha' in prolonged drawdowns (weaker in one-day crashes)",
          "Gold is near-universal but demoted historically (it fell in the dot-com bust) — yet for the 2026 configuration it is ELEVATED to lead regime-matched hedge, score 0.85 co-lead with cash (see Analytics ranking)"
        ]
      },
      {
        ...
        color: "#E0B458",
        items: [
          "Gold → monetary / inflation / currency crises — AND 'black-swan' ambiguity: investors buy gold on ambiguous signals, bonds on extreme-but-clear ones (Baur & McDermott 2012 working paper; Caballero & Krishnamurthy 2008)",
          "Value / small-value stocks → after equity-growth bubbles (dot-com)",
          "US dollar → EM and global funding-stress crises (Asia ’97, LTCM, 2008, 2020)",
          "Government bonds → deflationary crises specifically — they are the collapsing asset in sovereign/inflation crises",
          "Quality / low-beta → recessionary equity drawdowns generally"
        ]
      },
      {
        ...
        color: "#B48CE0",
        items: [
          "Oil / energy — 1973–74: crude ~4× post-embargo; the highest-MAGNITUDE unique winner, though the crisis TYPE recurs (1979, 1990, 2022) and oil FELL in the 2008/2020 demand collapses (Hamilton 2009)",
          "Homestake Mining & gold miners — 1930s: >500% Oct 1929–Dec 1935 vs a ~⅔ Dow loss (Burdekin & Weidenmier 2004) — the most NON-REPLICABLE winner (fixed-gold-price regime)",
          "Rolling Nikkei puts — Japan 1990",
          "Mega-cap tech — the COVID recovery trade, not the crash hedge",
          "Hoare's Bank timed exit — South Sea 1720 (IRR ≈ 51% p.a., Temin & Voth 2004)"
        ]
      },
      {
        ...
        color: "#E8853D",
        items: [
          "Bitcoin — fell in lockstep with equities in Mar 2020 (Conlon & McGee 2020); by Jul 2026 down ~51% from its ATH while indices set records",
          "Japanese yen (this cycle) — ~¥162, a ~40-year low despite repeated risk episodes; carry has dominated haven flows 2021–26"
        ]
      }
    ],
    CAT: {
      A: {
        label: "Equity / tech bubble",
        color: "#D4A017"
      },
      B: {
        label: "Real-estate / credit bubble",
        color: "#C0564A"
      },
      C: {
        label: "Classic mania",
      ...
      D: {
        label: "Currency / sovereign",
        color: "#4A90A4"
      },
      E: {
        label: "Liquidity / exogenous shock",
        color: "#6B7F6B"
      }
    },
    CLS: {
      market: {
        tag: "▼",
        name: "Collapsing market"
      },
      universal: {
        tag: "U",
        name: "Universal winner"
      },
      category: {
        tag: "C",
        name: "Category-specific winner"
      },
      unique: {
        tag: "★",
        name: "Crisis-unique winner"
      },
      falsified: {
        tag: "!",
        name: "Falsified safe haven"
      }
    }
  };

  // src/data.ts
  var CRISES = atlas_default.CRISES;
  var MATRIX = atlas_default.MATRIX;
  var MX_CRISES = atlas_default.MX_CRISES;
  var CLASSIFICATION = atlas_default.CLASSIFICATION;
  ...
  var rebase = (vals, baseMonth) => {
    const f = 100 / vals[baseMonth + 60];
    return vals.map((v) => v * f);
  };
  var fmtM = (m) => m === 0 ? "Crisis peak · t0" : `t${m > 0 ? "+" : "−"}${Math.abs(m)} mo`;
  var logPath = (vals) => vals.map((v) => Math.log(v));
  var ser = (id, key) => CRISES.find((c) => c.id === id).series.find((s) => s.key === key).a;
  function zArr(a) {
  ...
  var ChartTip = ({ active, payload, label }) => {
  ...
  var PB_COLS = ["M1", "M2", "M3/4", "M5", "M6", "M7", "M8", "M9", "M10"];
  var PB_VERDICTS = [
    {
      a: "Defense / aerospace",
  ...
  var EBASE = "https://www.etoro.com/markets/";
  var ET = {
